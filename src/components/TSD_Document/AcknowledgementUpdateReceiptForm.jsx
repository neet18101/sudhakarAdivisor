...
export default function AcknowledgementUpdateReceiptForm({ navigation }) {
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            const response = await fetch(URLActivity?.AcknowledgementUpdateReceiptForm, requestOptions);
