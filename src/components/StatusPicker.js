...
const StatusPicker = ({selectedValue, onValueChange, placeholder}) => {
                            ...
                            <FlatList
                                ...
                                renderItem={({item}) => (
                                    <TouchableOpacity
                                        ...
                                        onPress={() => {
                                            setSelectedCategoryName(item.Status); // Set selected category name
                                            onValueChange(item.StatusID); // Send CategID to the parent component
                                            setClicked(false);
                                        }}>
